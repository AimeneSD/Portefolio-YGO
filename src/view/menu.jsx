  ...
  return (
    <div className="relative h-screen w-full bg-black  grid grid-cols-20 grid-rows-20 gap-5 overflow-hidden">
      ...
      {/* 3. COLONNE DROITE (Subgrid 3 lignes) */}
        ...
        <div className="relative col-start-10 col-span-10 row-start-13 row-span-8">
          <MenuBlock 
          title="CONTACT" 
          color="bg-yellow-600" 
          clipClass="[clip-path:url(#smashCurve)]"
        />
        </div>

        {/*BARRE LATÉRALE*/}

        <div className="absolute col-start-18 col-span-2 row-span-20">
          <SideBar color="bg-white-500"/>
        </div>
      ...
      <svg width="0" height="0" className="absolute">
        <defs>
          <clipPath id="smashCurve" clipPathUnits="objectBoundingBox">
